...
const Scaffold = () => {
    return <div className='w-full flex flex-col  bg-slate-100 flex-grow overflow-hidden max-h-screen '>
        <div className='min-h-[3.5rem] h-14 w-full flex items-center justify-between px-4 text-xl font-bold  border-b bg-white'>
            <Link to={'/'} className='flex items-center gap-4  flex-row bg-w'>
