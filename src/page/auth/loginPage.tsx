...
const LoginPage = () => {
    return (
        <div className='w-full h-screen bg-slate-100 flex justify-center items-center'>
            <div className='flex flex-row gap-4 bg-white w-full justify-center lg:w-7/12  shadow-2xl shadow-blue-400 min-h-screen h-auto lg:min-h-[40dvh] xl:min-h-[50dvh]  rounded-2xl '>
                    ...
                    <div className='w-full flex gap-2 flex-col'>
                        <div className='flex flex-col text-sm w-full gap-2'>
                            ...
                            <div className='grid grid-cols-3 w-full items-center'>
                                <input placeholder='community domain prefix' className='h-12  w-full col-span-2 rounded-l text-black p-2 bg-slate-100 border-r-0 border-2 focus:outline-none focus:shadow-outline focus:border-2 focus:border-primary' />
                                <div className='flex font-bold tracking-widest text-black mr-2 h-12 col-span-1 rounded-r p-2 text-center justify-center bg-slate-100 border-2  border-l focus:outline-none focus:shadow-outline focus:border-2 focus:border-primary items-center'>.bettermode.com</div>
                            </div>
                        </div>
                        <div className='flex flex-col text-sm w-full gap-2'>
                ...
                <div className='lg:w-6/12 lg:flex flex-col justify-center items-center gap-4 py-2 hidden font-bold rounded-2xl'>
                    <img width={'45%'} height={'100%'} src='/public/side.svg' />
